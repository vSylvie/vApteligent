...
import com.example.test.apis.ApacheHttpClientApi;
import com.example.test.apis.GenericRequest;
import com.example.test.apis.GenericResponse;
import com.example.test.apis.HttpURLConnectionApi;
import com.example.test.apis.NetworkApi;
//import com.example.test.apis.OkHttpApi;
...
public class NetworkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        this.httpUrlConnectionCheckBox = v.findViewById(R.id.httpURLConnectionApi);
        this.apacheHttpClientCheckBox = v.findViewById(R.id.apacheHttpClientApi);
       // this.okHttpClientCheckBox = (CheckedTextView) v.findViewById(R.id.okHttpApi);
        ...
        this.httpCheckBox = v.findViewById(R.id.httpCheckBox);
        this.httpsCheckBox = v.findViewById(R.id.httpsCheckBox);
        this.httpCheckBox.setOnClickListener(schemeClickListener);
        this.httpsCheckBox.setOnClickListener(schemeClickListener);

        setNetworkAction(R.id.get1ByteButton, new NetworkAction("GET", ""));
        ...
        setNetworkAction(R.id.post1ByteButton, new NetworkAction("POST", "", 1));
        ...
        this.responsesTextView = v.findViewById(R.id.responsesTextView);
...
/*            if ( ! ( this.api instanceof com.example.test.apis.OkHttpApi ) ) {
